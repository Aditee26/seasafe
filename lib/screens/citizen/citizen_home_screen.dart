        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _quickAction(Icons.report, "Report", () => setState(() => _selectedIndex = 2)),
...
Container(
  ...
  child: ClipRRect(
    ...
    child: LiveOSMMap(
      key: const ValueKey("live_map"),
            ...
            const SizedBox(height: 12),
            _communityReport("High Waves", "Chennai Beach", "2h ago", Icons.warning, Colors.red),
            _communityReport("Oil Spill", "Mumbai Coast", "4h ago", Icons.water_drop, Colors.orange),
            _communityReport("Storm Alert", "Kerala", "6h ago", Icons.cloud, Colors.red),
          ],
        ),
      ),
    );
  ...
  Widget _communityReport(String title, String location, String time, IconData icon, Color color) {
    return Container(
