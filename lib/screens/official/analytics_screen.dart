                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildMetricItem('Resolution Rate', '78%', AppColors.success),
                      _buildMetricItem('Citizen Satisfaction', '4.2/5', AppColors.warning),
                    ],
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) => ListTile(
                      ...
                      subtitle: Text('${regionalData[index].incidents} incidents'),
                      trailing: Chip(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const ListTile(
                    ...
                    title: Text('High flood risk predicted for coastal regions'),
                    subtitle: Text('Next 7 days - 65% probability'),
                  ),
                  const ListTile(
                    leading: Icon(Icons.trending_down, color: AppColors.success),
